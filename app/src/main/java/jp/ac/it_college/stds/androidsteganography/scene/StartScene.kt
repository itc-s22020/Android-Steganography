...
import jp.ac.it_college.stds.androidsteganography.components.desing.Coral
import jp.ac.it_college.stds.androidsteganography.components.desing.LightYellow
...
fun StartScene(modifier: Modifier = Modifier, onEncryptClick: (Bitmap, Int) -> Unit = { _, _ -> }, onDecryptClick: (Bitmap, Int) -> Unit = { _, _ -> })  {
    ...
    val gradient = Brush.linearGradient(
        colors = listOf(Color(124,54,2), Color(121,11,22)),
    )
